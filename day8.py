'''
Tokens -->keywords,Identifiers,Literals,Operators,Pinctuators,Variables
...
#task: workout with all possibilites of slicing and strding on a example
'''
name = 'codegnan'
#name[3] = 'w' #strings are immutable

#Operations on strings -->Indexing,Concatenation,Repetiton,Membership
print(name *)
print('*' * 25) #repetition

#concatenation -> conmbining strings
'''
'''
...
name = 'codegnan data'
#case-conversions -->upper(),lower(),title(),capitalized()
a = name.upper()
print(a)
b = name.lower()
print(b)
